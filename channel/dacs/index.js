...
client.on('chat', (channel, user, message, self) => {                                       //Donowall
   ...
   client.action(streamer, `@r4kunnn ich bitte Sie darum sich wieder auf den chat zu konzentrieren und die überlesenen Nachrichten von ${user.username} vorzulesen! BONKTHESTREAMER`)
